...
if __name__ == "__main__":
    save_dir = './logs_bilstm2_{}_{}_{}_{}'.format(num_layers, hidden_size, sequence_length, pred_length)
    # train(save_dir=save_dir)
    print(save_dir)
    prediction(model_path='./logs_bilstm2_{}_{}_{}_{}/3_lstm.pth'.format(num_layers, hidden_size, sequence_length, pred_length))
